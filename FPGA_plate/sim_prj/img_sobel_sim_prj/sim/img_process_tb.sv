...
begin
	...
	#20
	rst_n		=	1'd1;
	output_file	=	$fopen("D:/2L676demo/img_sobel_sim_prj/img_sobel_sim_prj/sim/img_process.txt","w");
end
//生成 100MHZ
...
always@(posedge video_clk or negedge rst_n)	begin
	...
	begin
		$fdisplay(output_file,"%h\t%h\t%h",sobel_data,sobel_data,sobel_data);    //16进制写入  
	end
end
